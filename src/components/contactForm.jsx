...
const handleSubmit = async(e) => {
    ...
    return (
        <>
        <div>
            <h1 className="font-now text-marron uppercase text-lg pl-10 pt-10">Envianos tu consulta:</h1>
            <form onSubmit={handleSubmit}>

                <div className="flex flex-col px-10 py-2 md:px-0">
                ...
                <div className="flex justify-end pr-10 py-5 md:pr-0">
